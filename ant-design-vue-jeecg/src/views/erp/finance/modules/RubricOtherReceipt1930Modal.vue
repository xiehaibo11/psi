<template>
  <j-modal
    ...
    <template slot="footer">
      ...
      <a-button v-if="disableSubmit" :disabled="isDisabledAuth('RubricOtherReceipt1930:print')" key="print" @click="handlePrint" style="margin-right: 48px">打印</a-button>
...
<script>
  ...
  import BillForm from './RubricOtherReceipt1930Form';
  import { mixinDevice } from '@/utils/mixin.js'

  export default {
    name: 'RubricOtherReceipt1930Modal',
    mixins: [BillModalMixin, mixinDevice],
    components: {BillForm},

    data() {
      return {
        tip: '说明：其他收款退款(红字收款)生效后，可用【应收核销】手动核销销售预收、其他预收、销售收款、其他收款等！',
      }
    },
  }
</script>
