...
<script>
  ...
  export default {
    name: 'RubricOtherPayment2930Form',
    ...
    methods: {
      ...
      addAfter() {
        this.$refs.billHeader.fillBillNo('fin_qtfktk_bill_no');
      },
      ...
      editAfter() {
        if (this.model.id) this.requestSubTableData(this.entryTable.url.list, { id: this.model.id }, this.entryTable)
      },
