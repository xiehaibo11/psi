<template>
  <j-modal
    ...
    <template slot="footer">
      <a-button v-if="disableSubmit" :disabled="isDisabledAuth('PurPrepayment2011:print')" key="print" @click="handlePrint" style="margin-right: 48px">打印</a-button>
    ...
    <pur-prepayment-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit" :loading.sync="loading" :entryCount.sync="entryCount"/>
  </j-modal>
</template>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        width:1300,
        //20231221 cfm add: 相应的button 和 *-form属性也有改变
        loading: false,
        entryCount: 0
      }
    },
