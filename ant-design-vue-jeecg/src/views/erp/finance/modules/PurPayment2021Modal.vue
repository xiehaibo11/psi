<template>
  <j-modal
    ...
    <template slot="footer">
      ...
      <a-button v-if="disableSubmit" :disabled="isDisabledAuth('PurPayment2021:print')" key="print" @click="handlePrint" style="margin-right: 48px">打印</a-button>
    ...
    <pur-payment-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit" :loading.sync="loading" :entryCount.sync="entryCount"/>
  </j-modal>
</template>
