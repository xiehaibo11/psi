            ...
            >
              <template v-if="!disabled" v-slot:toolbarPrefix>
                ...
                <j-popup v-show="false" ref="orderPopup" code="pur_order" :param="orderPopupParam"
                         org-fields="id" dest-fields="id" :multi="false" @input="onOrderPopupInput"/>
              </template>
            </j-vxe-table>
          </a-tab-pane>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          ...
          queryById: "/finance/finPayment/queryById", //20251101 cfm add for 内置BPM
        },
      }
    },
    ...
    computed: {
      ...
      addDisabled() {
        return stringIsEmpty(this.model.supplierId) || this.entryTable.rowCount > 0;
      },
