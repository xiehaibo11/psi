...
public class FinPurInvoiceController {
	...
	@RequiresPermissions("finance:purchase:invoice:add") //20240806 cfm add
	...
	@RequiresPermissions("finance:purchase:invoice:edit") //20240806 cfm add
	...
	@RequiresPermissions("finance:purchase:invoice:delete") //20240806 cfm add
	...
	public Result<?> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
	 ...
	 @RequiresPermissions("finance:purchase:invoice:check") //20240806 cfm add
	 ...
	 @RequiresPermissions("finance:purchase:invoice:bpm:end") //20240806 cfm add
	 ...
	 @RequiresPermissions("finance:purchase:invoice:execute") //20240806 cfm add
	 ...
	 @RequiresPermissions("finance:purchase:invoice:close") //20240806 cfm add
	 ...
	 @RequiresPermissions("finance:purchase:invoice:unclose") //20240806 cfm add
	 ...
	 @RequiresPermissions("finance:purchase:invoice:void") //20240806 cfm add
    ...
    */
	...
	@RequiresPermissions("finance:purchase:invoice:export") //20240806 cfm add
    ...
    public ModelAndView exportXls(HttpServletRequest request, FinPurInvoice finPurInvoice) {
	 ...
	 @RequiresPermissions("finance:purchase:invoice:import") //20240806 cfm add
